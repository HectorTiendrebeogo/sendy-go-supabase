...
export type StatusResponseType = Omit<InitialStatusResponseType, "custom_data"> & {
    custom_data: Record<string, any>;
};
export type InitialLigdicashResponseType = InitialBaseResponseType | InitialStatusResponseType;
